...
public class FindBookByAuthorUseCaseTest {
    ...
    void shouldShowAllBookFromSelectedAuthor(){
        ...
        when(repository.findByAuthor("J. R. R. Tolkien")).thenReturn(domainList);

        List<BookResponseDto> resultList = findBookByAuthorUseCase.execute("J. R. R. Tolkien");
